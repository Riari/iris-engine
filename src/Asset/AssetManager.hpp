...
namespace Iris
{
    ...
    public:
        ...
        [[nodiscard]] std::shared_ptr<GL::ShaderProgram> GetShaderProgram(std::string name) const;
        ...
        [[nodiscard]] std::shared_ptr<GL::Texture> GenerateTexture(std::string path) const;
