...
namespace OGL::GL
{
    Texture::Texture(std::shared_ptr<Asset::Image> image) : m_image(std::move(image))
    {
    ...
    void Texture::Define(bool withMipmap) const
    {
        ...
        switch (m_image->GetChannels())
        {
            ...
            case 4:
                ...
                break;
            default:
                throw Exception::Exception(fmt::format("Unexpected channel count in image data: {0} ({1} channels)",
